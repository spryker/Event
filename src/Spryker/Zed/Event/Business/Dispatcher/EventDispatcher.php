...
class EventDispatcher implements EventDispatcherInterface
{
    ...
    public function trigger(string $eventName, TransferInterface $transfer): void
    {
        ...
        foreach (clone $eventListeners as $eventListener) {
            if ($eventListener->isHandledInQueue()) {
                $this->eventQueueProducer->enqueueListener($eventName, $transfer, $eventListener->getListenerName(), $eventListener->getQueuePoolName(), $eventListener->getEventQueueName());
            } else {
    ...
    public function triggerBulk(string $eventName, array $transfers): void
    {
        ...
        foreach (clone $eventListeners as $eventListener) {
            if ($eventListener->isHandledInQueue()) {
                $this->eventQueueProducer->enqueueListenerBulk($eventName, $transfers, $eventListener->getListenerName(), $eventListener->getQueuePoolName(), $eventListener->getEventQueueName());
            } else {
